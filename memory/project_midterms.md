...
| **AC311** Intermediate Acct 1 | Kieso, Weygandt, Warfield, *Intermediate Accounting* **IFRS Edition, 4e** (Wiley). ✅ IFRS ed. — matches the TFRS jurisdiction rule. | **Midterm 1 only**, sessions 1–7 → Kieso **Ch 7** (Cash & Receivables), **Ch 8–9** (Inventories, TAS 2), **Ch 13** (Provisions/Contingencies, TAS 37). | **40%** — ✅ **CONFIRMED 28 Aug, no contradiction.** Syllabus grading table and course plan both say 40%; full split is M1 40 / M2 30 / Final 25 / Quiz+Assignment 5 = 100. The earlier "35% in the schedule table" note was my misread — corrected. |
...
|---|---|---|
| `AC311-BBA-1-2026 Course Syllabus 026401.pdf` | 6 | Also in `~/Desktop/class outline/` since 24 Aug |
| `01-Cash and Receivables.pdf` | 34 | **Full deck, sessions 1–2** |
| `02-AC311-BBA-Inventories.pdf` | 66 | **Full deck, sessions 3–4** |
...
➡️ Best available outcome now: **close Cash + Inventories before 31 Aug** so September's only new AC311 load is the three Provisions Mondays.

### Session map (from the syllabus)
| Sessions | Dates | Topic | Status 28 Aug |
|---|---|---|---|
| 1–2 | Mon 3, 10 Aug | Cash & Accounts Receivable (Ch 7) | ✅ taught, deck in hand |
| 3–4 | Mon 17, 24 Aug | Inventories (Ch 8–9, TAS 2) | ✅ taught, deck in hand |
| 5–7 | Mon 31 Aug, 7 Sep, 14 Sep | Provisions / Contingent Liabilities / Contingent Assets / Onerous contracts (Ch 13, TAS 37) | 🔴 **not yet taught** |

Instructors: **Ajarn Pailin Trongmateerut** sessions 1–7 (Mon 13:00–16:00, room 205, pailin@tbs.tu.ac.th) → **Ajarn Saifon Inkaew** sessions 8–15 (Sat 09:00–12:00). TA: Nattanicha Kamdee (P'Aom).
...
2. **Reverse-plan from each exam date**, not forward from today.
3. **Triage by standing, not by exam order** — a catching-up subject with a late exam can outrank an on-top subject with an early one.
4. **One intention per study day, not a full schedule** — how he actually works ([[user-korn-struggles]]: directionlessness is fixed by intention, not discipline). Each block names one concrete deliverable.
5. Blocks go on the **Life** calendar, notificationLevel NONE ([[reference-calendars]]).
6. **Front-load week 1.** A comfortable 4-week runway is how a plan gets built and not started.
...
- ✅ **RESOLVED 22 Sep 16:37 — STQ05 IS NOW ON DISK.** `~/Desktop/fn/FN201-26F-BBA-STQ05-FE&M-Q1-30&S1-25-V4-260909.pdf` (Q1–30, solutions Q1–25 in the same PDF) + `FN201-26F-BBA-STQ05-FE&M-S26-30-P2-of-2-V4-260909.xlsx` (solutions Q26–30). **Shape: ~24 conceptual MCQ; computational = Q11 (nominal r_f from r* + inflation), Q25 (DRP per year off a yield table), Q26–30 (a shared data block: nominal r_f, 2-yr govt bond, X debentures, AA−/AA+ DRP gap, implied LP).**
...
- ~~Her activity text ⇒ DSO is ACTIVITY~~ 🔴 **WRONG — CORRECTED 21 Sep by reading LN3 ITSELF.** **DSO IS DUAL-LISTED IN OBROM'S OWN DECK:** it appears as **(a-6) under (a) Liquidity ratios — "(iii) Measurement: **Liquidity**"** AND as **(b-4) under (b) Activity/asset management — "(iii) Measurement: Ability of the firm to manage its accounts receivable."** Each entry says *"See also"* the other. **Accounts receivable turnover (ART) is dual-listed the same way, (a-5) and (b-3).**
  - ⇒ **The rule to teach: liquidity when the point is CONVERTING receivables to cash; activity when the point is MANAGING receivables.** Not a single-family ratio.
  - ⇒ **Korn's 20 Sep "leverage" and 21 Sep "profitability" were both still wrong** — but his repeated uncertainty on this one ratio was partly justified, and Crow drilled a too-confident single answer at him TWICE.
  - 🚨 **CROW ERROR, SAME SHAPE AS THE 14 SEP AC311 ONE: asserted a family from the FAMILY-DESCRIPTION text instead of opening the deck's own ratio entry.** The deck was on disk the whole time. **Read the entry, not the heading.**
  - 📛 **NAMING: he calls it ACP / DSO / ARD (accounts receivable days) interchangeably — if Korn can't find "DSO" on a sheet, look for ACP or ARD.**
...
⛔ **Q28 MODEL ANSWERS (he must NOT see them): i/m = 2%, n = 40, 10 yrs. (a) PV = 29,244.60 × PVIFA(2%,40 = 27.3555) = **800,000.05** · (b) remaining principal at t=39 = PV of the ONE last installment = 29,244.60/1.02 = 28,671.18 ⇒ repaid = 800,000.05 − 28,671.18 = **771,328.87** · (c) I₄₀ = remaining principal at t=39 × i/m = 28,671.18 × 0.02 = **573.42** · (d) EAR = 1.02⁴ − 1 = **8.2432%** · (e) add-on: total interest = P × i × n = 800,000 × 0.08 × 10 = 640,000 ⇒ obligation 1,440,000 ⇒ A = **36,000.00** · (f) add-on interest is SPREAD EQUALLY = P × (i/m) = **16,000.00** per period (NOT 573.42 — that is the whole point of the (c)-vs-(f) pairing).
...
### 🎓 AC311 FULL RECAP DRILL — 24 Sep 2026 (~67 questions, question-first, he wrote corrections on paper)
Scope was widened mid-session on HIS catch: Crow had scoped to Part I only; a full sweep of all AC311 PDFs (cash deck, both inventory decks, provisions deck, practice set + solutions, syllabus) produced the complete checklist.
- ✅ Fixed since 15 Sep: **balance-vs-movement** (฿40k recovery right) · **purchase/sales commitment direction** (right both ways) · **contingent liability treatment stated unprompted** · FIFO/WAC exact · VAT full cycle clean · transit/consignment clean.
- 🔴 Still weak: **stops one sentence early** (method names, the number, the credit side, the reason) — persisted all session · **Dr/Cr inversion** (COGS/Inventory flipped) · **lender vs borrower on notes** (interest payable/expense instead of revenue, twice) · annual rate × months/12 · cost ceiling on recovery (said 30, correct 20) · loss = cost − NRV (not cost − selling price) · aging concept needed a walk-through ("jar" framing landed) · compensating balance = restricted · petty cash IS cash · retraining after law change = no provision · reimbursement virtually certain = separate asset (NOT in her deck).
- 📛 **Her exact account names (verified in deck):** Loss from Decline in Value of Inventory / Allowance for Decline in Value of Inventory · Loss from/on Purchase Commitment / Provision from Purchase Commitment · Recovery of Loss on Purchase Commitments (alt: Gain from reversal of purchase commitment) · Provision from sales contract (her handwriting) · Loss from lawsuits / Provision for loss from lawsuits · Warranty Expense / Provision under Warranty · Inventory Short and Over · Input Tax / Output Tax / VAT Payable · Bad Debt Expense / Allowance for Doubtful Accounts. **Her FOB has no shipping-point/destination split** — FOB and CIF both = buyer's once loaded; DDP = seller's until delivered.
- ⏳ Not yet drilled: purchase-commitment full cycle (Problems 3 & 5, Rollins A/B), Problem 4 in full, Tucson, smoke filters, Solon, medical (5b), short-term liabilities (optional), statements.

### 📂 AC311 practice pack on disk (added by Korn 25 Sep)
- `~/Desktop/ปีศาจ/` = `Practice Exercises-Inventories-Liabilities.pdf` (7 pp: questions pp.1–3, **solutions pp.4–7**) + her two template photos `IMG_2470 2.heic` (SOCI) / `IMG_2471 2.heic` (SOFP).
