...
- ⚠️ **Basketball is unprogrammed load and is far harder on his ankle than running is** (cutting, landing, eccentric stress — [[project-training-plan]] injury note). **Open question: is it a one-off or recurring?** If recurring it's effectively a 5th session and must be counted, not ignored.
