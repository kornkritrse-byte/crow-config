...
| **IS201** Digital Technology | **Hiding in the Noise** — https://claude.ai/code/artifact/ecc4bbbd-d2ab-44ad-a2c4-3e1977d163d2 | **Individual presentation deck (20 pts), built 30 Aug.** Topic: lattice-based / post-quantum cryptography. 11 slides, 16:9, arrow-key nav, F for fullscreen, print CSS = 1 slide/page for PDF. Live canvas lattice diagram (skewed basis vectors + noise cloud). Speaker notes + a **6:20 timing plan** below the deck. ⚠️ **Placeholders he must fix: surname on slide 1, and the student ID 6802640661 was inferred from his FN201-A1 filename — unverified.** 🔴 **Slide 07 (cryptographic inventory / CBOM dashboard) exists to satisfy the brief's requirement 2 (data visualisation / analysis / BI) — his topic does not otherwise meet it. He must not skip that slide.** Palette validated with the dataviz skill's script (risk #D9541E / safe #2F6FB8 light; #DE6E36 / #5A97D8 dark — all six checks pass). Syne + Work Sans + IBM Plex Mono. |
