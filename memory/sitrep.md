...
- ⚠️ **Lecturer pronouns:** never stated. The original artifact guessed "he", I then guessed "she" — **both wrong to assert; all lecturer references now neutralised to they/them** and the name added once (Asst. Prof. Dr Patharawan Chongchit, "Ajarn Pattie"). Keep it that way unless Korn says otherwise.
