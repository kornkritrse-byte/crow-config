...
- 📌 **AC313 GAPS LEFT (verified against [[project-midterms]] line 279): FIFO vs weighted-average · transferred-in costs · spoilage in process costing.** Plus: constant gross-margin % NRV (Horngren's 4th method, NOT in her outline — he is checking Monvika's slides). ⚠️ Crow called byproducts "the last hole" — **wrong, three topics remain.**
