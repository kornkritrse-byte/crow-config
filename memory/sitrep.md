...
- **Reading (two in parallel):** (1) **Karamazov** — Book 10, ch. 1–2 done (Kolya + the kids, 03 Jul). ⚠️ No spoilers past Book 10 ch. 2 (no Zhuchka/Perezvon, Ilyusha bedside, trial, Smerdyakov, Ivan/devil, Epilogue). (2) **After Dark** — ✅ FINISHED 14 Jul (finished around dawn, didn't wait for the rainy night after all). **Next before-sleep book = Letters to Milena** (owned — on the love thread he's circling). Takeaway not yet captured — ask when he wants to talk about it. Always ask exactly where he is first. Full history + owned-unread shelf: [[user-reading-list]].
