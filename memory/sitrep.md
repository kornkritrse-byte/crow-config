...
- Known leftover (flagged, untouched): save.sh copies but never deletes — a memory deleted on the live side leaves a zombie in the repo until manually git-rm'd.
