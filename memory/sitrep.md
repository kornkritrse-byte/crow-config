...
- **Parked by Korn:** Bass Trainer Mac port ("can wait" — needs the Windows laptop awake). Days-to-camp countdown in the start banner — floated, no call yet. Explicitly not worth doing: flow-sheet rename (now unblocked but cosmetic), log pruning, sixth crew member.
