...
## Session — 2026-09-18 (BA202 schedule-offset SOLVED · cold FIFO rep PASSED) — flushed from SITREP 20 Sep
- 🔑 **The 16 Sep BA202 alarm was WRONG — the class runs ~one deck BEHIND the handout names.** L5 (2 Sep) = PIT deductions/allowances, L6 (9 Sep) = PIT recap + opening of CIT. ✅ **L7 transcribed 18 Sep — scope CLOSED: PIT (L1–L5, the bulk) + CIT (L6–L7) + special regimes at concept level only. PETROLEUM INCOME TAX WAS NEVER TAUGHT; no BOI or treaty detail.** ⚠️ Still unverified: whether she examines her posted DECKS beyond what she said.
- ✅ **Cold FIFO rep PASSED** (Nakhon Sawan Sugar, 16 hrs cold, notebook only): all six EU buckets unaided, tie-out 215,800 ✓. One nudge — opening-WIP group answered as prior cost only; **corrected to a structure: opening WIP = prior cost + what this month did to finish it.**
- 🚨 **AC313 FORMAT REVEALED (prof's own review sheet): 47 MCQ, 100 points, closed book, any calculator (bring two), 3 pages of scratch paper that MUST be returned for 6 points. NO constructed response** ⇒ speed to a number, not layout recall. **Killed the "no formula sheet ⇒ reproduce every layout" premise.**
- ✅ Korn was right: **spoilage in PROCESS costing is NOT tested**; but Topic 2 REQUIRES spoilage + rework journal entries under JOB costing (Ex.1 Q9 & Q10). **Q9 + Q10 CLOSED same day, all six cases**, Q10's three debits in one go with no scaffolding. Scrap (Q11) out in both places. Transferred-in cost assignment (WA + FIFO) explicitly IN scope; constant gross-margin NRV OUT.
- ⚠️ **"Right idea, wrong scope" became a THREE-TIME pattern and was named to him** ($7,000 spoiled-unit residual given as the job's WIP balance; the ฿192,000 cost pool; the transferred-in 100% smear). **He grabs the sub-group when asked about the whole, or vice versa.**
